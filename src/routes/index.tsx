...
function Hero() {
  return (
    ...
    <img src="https://i.ibb.co/QjmV1sq0/Whats-App-Image-2026-07-13-at-4-24-44-PM.jpg" alt="" aria-hidden className="h-full w-full object-cover object-center scale-110 blur-2xl opacity-40" />
